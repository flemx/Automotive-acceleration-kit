    ...
    */
    ...
    loadValue : function(component, skipTypeaheadLoading){
        ...
        action.setCallback(this, function(a) {
            ...
            /*if(type!=null && val!=null && result!=null)
            {
                console.log('result not null');
                console.log('type:'+type+'val:'+val+'res:'+result);
                var InputEvent = $A.get("e.c:DE_InputLoopkupValues");
                InputEvent.setParams({input_type:type});
                InputEvent.setParams({input_val:val});
                InputEvent.setParams({input_result:result});
                InputEvent.fire();
            }*/
            ...
            if(result)
                jQuery('[id="'+globalId+'_typeahead"]').val(result || '');
