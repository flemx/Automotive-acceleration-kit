Webruntime.moduleRegistry.define('c/amfTestDriveForm', ['lwc'], function (lwc) { 'use strict';
    ...
    function tmpl$1($api, $cmp, $slotset, $ctx) {
      ...
      return [api_element("div", {
        ...
        attrs: {
          "xlink:href": lwc.sanitizeAttribute("use", "http://www.w3.org/2000/svg", "xlink:href", "/assets/icons/utility-sprite/svg/symbols.svg#knowledge_base")
        },
        key: 7
      }, [])])])]), api_element("div", {
        classMap: {
        ...
        key: 9
      }, [api_text("Share the knowledge")]), api_element("p", {
        classMap: {
          "slds-m-top_small": true
        },
        key: 10
      }, [api_text("Harness your team's collective know-how with our powerful knowledge base")])])])]), api_element("fieldset", {
        classMap: {
        ...
        key: 12
      }, [api_text("Select a plan")]), api_element("div", {
        classMap: {
        ...
        classMap: {
          ...
          "slds-visual-picker_medium": true
        },
        key: 14
      }, [api_element("input", {
        attrs: {
          "type": "radio",
          "id": api_scoped_id("visual-picker-79"),
          "name": "options"
        },
        props: {
          "value": "visual-picker-79"
        },
        key: 15
      }, []), api_element("label", {
        attrs: {
          "for": `${api_scoped_id("visual-picker-79")}`
        },
        key: 16
      }, [api_element("span", {
        classMap: {
        ...
        key: 19
      }, [api_text("$30")]), api_element("span", {
        classMap: {
          "slds-text-title": true
        },
        key: 20
      }, [api_text("USD/user/month *")])])]), api_element("span", {
        classMap: {
          "slds-visual-picker__body": true
        },
        key: 21
      }, [api_element("span", {
        classMap: {
        ...
        key: 22
      }, [api_text("Lightning Professional")]), api_element("span", {
        classMap: {
          "slds-text-title": true
        },
        key: 23
      }, [api_text("Complete service CRM for teams of any size")])]), api_element("span", {
        classMap: {
          "slds-icon_container": true,
        ...
        attrs: {
          "type": "radio",
          "id": api_scoped_id("visual-picker-80"),
          "name": "options"
        },
        props: {
          "value": "visual-picker-80"
        },
        key: 28
      }, []), api_element("label", {
        attrs: {
          "for": `${api_scoped_id("visual-picker-80")}`
        },
        key: 29
      }, [api_element("span", {
        classMap: {
        ...
        key: 35
      }, [api_text("Lightning Enterprise")]), api_element("span", {
        classMap: {
          "slds-text-title": true
        },
        key: 36
      }, [api_text("Everything you need to take support to the next level")])]), api_element("span", {
        classMap: {
          "slds-icon_container": true,
          "slds-visual-picker__text-check": true
        },
        ...
        attrs: {
          "type": "radio",
          "id": api_scoped_id("visual-picker-81"),
          "name": "options"
        },
        props: {
          "value": "visual-picker-81",
          "disabled": ""
        },
        key: 41
      }, []), api_element("label", {
        attrs: {
          "for": `${api_scoped_id("visual-picker-81")}`
        },
        key: 42
      }, [api_element("span", {
        classMap: {
        ...
        key: 48
      }, [api_text("Lightning Unlimited")]), api_element("span", {
        classMap: {
          "slds-text-title": true
        },
        key: 49
      }, [api_text("Complete support with enterprise-grade customization")])]), api_element("span", {
        classMap: {
          "slds-icon_container": true,
          "slds-visual-picker__text-check": true
        },
