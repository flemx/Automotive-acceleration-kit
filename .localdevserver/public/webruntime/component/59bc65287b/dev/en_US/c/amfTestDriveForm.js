Webruntime.moduleRegistry.define('c/amfTestDriveForm', ['lwc'], function (lwc) { 'use strict';
    ...
    function stylesheet$2(hostSelector, shadowSelector, nativeShadow) {
      return ".mainWrapper" + shadowSelector + "{display: flex;align-items: center;justify-content: center;}\n.mainContainer" + shadowSelector + "{display: flex;align-items: center;justify-content: center;width: 80%;margin-top: 5%;max-width: 1000px;}\n";
    }
