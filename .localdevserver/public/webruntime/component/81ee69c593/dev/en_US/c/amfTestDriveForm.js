Webruntime.moduleRegistry.define('c/amfTestDriveForm', ['lwc', 'webruntime/configProvider'], function (lwc, configProvider) { 'use strict';
    ...
    var VEHICLE_IMAGES = `${configProvider.getBasePath()}/assets/4ad4712c39/vwDemoPackFiles`;
    ...
    function tmpl$2($api, $cmp, $slotset, $ctx) {
      ...
      return [api_element("fieldset", {
        ...
        key: 3
      }, [api_text("Salutation")]), api_element("div", {
        classMap: {
          "slds-form-element__control": true
        },
        key: 4
        ...
        key: 9
      }, [api_text("Lead Generation")])])]), api_element("span", {
        classMap: {
          "slds-radio": true
        },
        key: 10
        ...
        key: 14
      }, [api_text("Education Leads")])])])])]), api_element("fieldset", {
        classMap: {
          "slds-form-element": true,
        ...
        attrs: {
          "for": `${api_scoped_id("input-01")}`
        },
        key: 20
      }, [api_text("Latitude")]), api_element("div", {
        classMap: {
          "slds-form-element__control": true
        },
        key: 21
        ...
        attrs: {
          "for": `${api_scoped_id("input-02")}`
        },
        key: 25
      }, [api_text("Longitude")]), api_element("div", {
        classMap: {
          "slds-form-element__control": true
        },
        key: 26
