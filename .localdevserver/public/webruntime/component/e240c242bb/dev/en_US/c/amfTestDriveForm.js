Webruntime.moduleRegistry.define('c/amfTestDriveForm', ['lwc', 'webruntime/configProvider'], function (lwc, configProvider) { 'use strict';
    ...
    var VEHICLE_IMAGES = `${configProvider.getBasePath()}/assets/25b1c87bfd/vwDemoPackFiles`;
    ...
    function stylesheet$3(hostSelector, shadowSelector, nativeShadow) {
      return ".container" + shadowSelector + "{width: 80%;margin-left: 10%;}\n";
    }
    ...
    function tmpl$2($api, $cmp, $slotset, $ctx) {
      ...
      return [api_element("fieldset", {
        ...
        key: 19
      }, [api_text("Street")]), api_element("div", {
        classMap: {
          "slds-form-element__control": true
        },
        key: 20
        ...
        key: 24
      }, [api_text("Postal Code")]), api_element("div", {
        classMap: {
          "slds-form-element__control": true
        },
        key: 25
        ...
        key: 36
      }, [api_text("Country")]), api_element("div", {
        classMap: {
          "slds-form-element__control": true
        },
        key: 37
        ...
        key: 48
      }, [api_text("Phone")]), api_element("div", {
        classMap: {
          "slds-form-element__control": true
        },
        key: 49
    ...
    lwc.registerDecorators(amfContactDetails, {
      publicProps: {
        firstName: {
          config: 0
        },
