Webruntime.moduleRegistry.define('webruntimegenerated/view__home', ['lwc', 'lightning/configProvider'], function (lwc, configProvider) { 'use strict';
    ...
    **/
    ...
    var html = lwc.registerTemplate(tmpl$9);
    tmpl$9.stylesheets = [];
